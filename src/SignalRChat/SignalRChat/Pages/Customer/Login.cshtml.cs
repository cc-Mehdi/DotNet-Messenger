...
namespace SignalRChat.Pages.Customer
{
    public class LoginModel : PageModel
    {
        ...
        {
            ModelState["User.PublicId"].ValidationState = ModelValidationState.Valid;
            ModelState["User.Username"].ValidationState = ModelValidationState.Valid;
            ModelState["User.PictureAddress"].ValidationState = ModelValidationState.Valid;
            ...
            if (User.Id != 0)
            {
                ...
                ViewData["Title"] = $"Welcome {User.Username}";
                return RedirectToPage("./../Index");
            }

            ViewData["Title"] = "Email or Password is incorrect!";
            return Page();
